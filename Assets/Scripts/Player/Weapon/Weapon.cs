...
public class Weapon : MonoBehaviour
{
    ...
    public BulletParameters bullet;
    //Weapon parameters
    [Header("Weapon Setup")]
    ...
    private void Awake()
    {
        ...
        linearAirResistance = 4.8f / 10 * bullet.EmpMultiplier * bullet.SqrRadius / bullet.Mass;
    ...
    void Update()
    {
        ...
        Transform bul = null;
       // startSpeed = 1566f * length * bullet.Powder;
        if (Input.GetKeyDown(KeyCode.Mouse0))
        {
            GetComponent<AudioSource>().Play();
            StartCoroutine(Flick());
            firePoint.localRotation = Quaternion.Euler(Random.insideUnitSphere * (angleError + 0*(temperature - 273) / 400)) * firePoint.localRotation;
            ...
            bul.GetComponent<Projectle>().SetParameters(firePoint.forward.normalized * (totalSpeed), linearAirResistance, bullet.Mass, square, bullet.Derrivation);
